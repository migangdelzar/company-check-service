...
class RuntimeProfileConfigurationTest {
  ...
  void singleNodeProfileUsesLocalCoordinationAndResilience4j() {
    new ApplicationContextRunner()
        ...
        .run(
            context -> {
              assertInstanceOf(
                  LocalCoordinationRepository.class, context.getBean(CoordinationRepository.class));
              assertTrue(context.getBeansOfType(RedisCoordinationRepository.class).isEmpty());
              ...
              assertEquals(
                  Set.of("FreeProviderClient", "PremiumProviderClient"), providerTypes(context));
            });
  }
    ...
    new ApplicationContextRunner()
        ...
        .run(
            context -> {
              ...
              assertTrue(context.getBeansOfType(LocalCoordinationRepository.class).isEmpty());
              assertInstanceOf(
              ...
              assertEquals(
                  Set.of("DistributedFreeProviderClient", "DistributedPremiumProviderClient"),
  ...
  private Set<String> providerTypes(ApplicationContext context) {
    return context.getBeansOfType(ProviderClient.class).values().stream()
