...
public class DistributedPremiumProvider extends ResilientProvider {
  private final ProviderRateLimiter rateLimiter;

  public DistributedPremiumProvider(ProviderLookupPort delegate, ProviderRateLimiter rateLimiter) {
    super(delegate);
