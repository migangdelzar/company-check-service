...
public final class VerificationStateMapper {
  private static final int VERSION = 1;
  private final ObjectMapper mapper;

  public VerificationStateMapper(ObjectMapper mapper) {
    this.mapper = mapper;
  }

  public String encode(VerificationState state) {
    try {
  ...
  public VerificationState decode(String json) {
    try {
